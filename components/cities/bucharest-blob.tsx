          ...
          >
            ...
            >
              ...
              <div className="text-purple-600 dark:text-purple-400">
                {"const"} <span className="text-cyan-600 dark:text-cyan-400">website</span> = {"{"}
              </div>
              <div className="pl-3 text-foreground/80">
                city: <span className="text-green-600 dark:text-green-400">"București"</span>,
              </div>
              <div className="pl-3 text-foreground/80">
                seo: <span className="text-yellow-600 dark:text-yellow-400">100</span>,
              </div>
              <div className="pl-3 text-foreground/80">
                speed: <span className="text-cyan-600 dark:text-cyan-400">"blazing"</span>
              </div>
